...
liste_ligne =[[liste_arret1,liste_arc1],[liste_arret2,liste_arc2]]
#l'indice de la liste corespond au numéro de la ligne -1

    
###Creation du graph###
#On transforme les temps en réelscar ils ne sont qu'en minutes   
graph = EF.graph(liste_ligne)


###execution des programmes###
print("")
print(graph.fastest("Vernod", "PISCINE-PATINOIRE"))
print("")
print(graph.fastest("Pommaries", "Vernod" ))
print("")
print(graph.shortest("Pommaries", "Vernod"))
